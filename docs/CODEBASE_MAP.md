...
| Change global frontend boot behavior | [`src/routes/+layout.svelte`](../src/routes/+layout.svelte)                       | [`src/lib/stores/index.ts`](../src/lib/stores/index.ts), [`src/lib/constants.ts`](../src/lib/constants.ts)                                                                                                                                                                             |
