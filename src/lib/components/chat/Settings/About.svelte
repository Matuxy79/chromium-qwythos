	...
	<div class="flex-1 min-h-0 overflow-y-auto scrollbar-hover pr-1.5">
		...
		<UserSettingSection title={$i18n.t('Community')}>
			{#if $config?.license_metadata}
				<div class="text-xs text-gray-600 dark:text-gray-400">
					{#if !$WEBUI_NAME.includes('Qwythos')}
			...
			<div class="text-xs text-gray-400 dark:text-gray-500">
				...
				<a href="https://qwythos.com" target="_blank" class="underline">Qwythos Inc.</a>
				<a href="https://github.com/qwythos/qwythos/blob/main/LICENSE" target="_blank"
