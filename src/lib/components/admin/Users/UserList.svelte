		...
		<div class="mt-3 mb-3 pb-1 text-gray-700 dark:text-gray-300">
			<div class="max-w-3xl text-xs leading-5">
				<div class="text-gray-900 dark:text-gray-100">
					{$i18n.t('Running Qwythos for a team?')}
				</div>
				<div class="mt-2 space-y-2">
					<p>
						{$i18n.t(
							'You have more than 50 users, which often means this workspace is supporting organizational use. Qwythos is free to use as-is, with no restrictions or hidden limits, and we want to keep it that way.'
						)}
					</p>
					<p class="text-gray-500 dark:text-gray-400">
						{$i18n.t(
							'By supporting the project through sponsorship or an enterprise license, you help us stay independent, ship new features faster, improve stability, and grow Qwythos for the long haul.'
						)}
					</p>
					<p class="text-gray-500 dark:text-gray-400">
						{$i18n.t(
				...
				<div class="mt-2 flex items-center gap-3">
					<a
						...
						href="https://docs.qwythos.com/enterprise"
						target="_blank"
						rel="noreferrer"
					>
					...
					<a
						...
						href="https://github.com/sponsors/qwythos"
						target="_blank"
						rel="noreferrer"
					>
