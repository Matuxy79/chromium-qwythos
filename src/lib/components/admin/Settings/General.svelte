		...
		{#if adminConfig !== null}
			<AdminSettingSection first>
					...
					<div class="min-w-0 text-xs">
						...
						<div class="mt-1 flex flex-wrap gap-x-1 text-gray-700 dark:text-gray-200">
							...
							{#if $config?.features?.enable_version_update_check}
								<a
									href="https://github.com/qwythos/qwythos/releases/tag/v{version.latest}"
									target="_blank"
				...
				<div class="text-xs">
					...
					<div class="mt-1 flex flex-wrap gap-x-3 gap-y-1 text-gray-400 dark:text-gray-600">
						...
						<a
							class="hover:text-gray-700 dark:hover:text-gray-300"
							href="https://twitter.com/Qwythos"
							target="_blank">X</a
						>
						<a
							class="hover:text-gray-700 dark:hover:text-gray-300"
							href="https://github.com/qwythos/qwythos"
			...
			<AdminSettingSection title={$i18n.t('Features')}>
				<AdminSettingRow
					...
					description={$i18n.t('Allow users to share chats with the Qwythos community.')}
					let:labelId
				>
