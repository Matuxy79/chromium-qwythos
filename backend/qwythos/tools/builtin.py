...
from qwythos.tools.knowledge_fs import kb_exec  # noqa: F401 — re-exported
...
from qwythos.config import RAG_EMBEDDING_QUERY_PREFIX
from qwythos.env import (
    KNOWLEDGE_GREP_MAX_MATCHES,
    VIEW_FILE_DEFAULT_MAX_CHARS,
    VIEW_FILE_MAX_CHARS,
)
from qwythos.models.channels import Channel, ChannelMember, Channels
from qwythos.models.chats import Chats
from qwythos.models.config import Config
from qwythos.models.groups import Groups
from qwythos.models.memories import Memories
from qwythos.models.messages import Message, Messages
from qwythos.models.notes import Notes
from qwythos.models.users import UserModel
from qwythos.retrieval.utils import get_content_from_url
from qwythos.retrieval.vector.async_client import ASYNC_VECTOR_DB_CLIENT
from qwythos.routers.images import (
    CreateImageForm,
    EditImageForm,
    image_edits,
    image_generations,
)
from qwythos.routers.memories import (
    AddMemoryForm,
    ListMemoryPathsForm,
    MemoryUpdateModel,
    ReadMemoryPathForm,
...
from qwythos.routers.retrieval import search_web as _search_web
from qwythos.tasks import stop_item_tasks
from qwythos.events import EVENTS, publish_event
from qwythos.socket.main import sio
from qwythos.utils.chat_id import is_saved_chat_id
from qwythos.utils.notifications import notify_target
...
async def notify(
    ...
    app_name = getattr(app_name, 'WEBUI_NAME', 'Qwythos')
    try:
...
async def execute_code(
    ...
    try:
        ...
        from qwythos.config import CODE_INTERPRETER_BLOCKED_MODULES
        ...
        if engine == 'pyodide':
            ...
            from qwythos.utils.code_interpreter import execute_code_jupyter
        ...
        if __user__ and __user__.get('id'):
            from qwythos.models.users import Users
            from qwythos.utils.files import get_image_url_from_base64
...
async def write_note(
    ...
    try:
        from qwythos.models.notes import NoteForm
...
async def replace_note_content(
    ...
    try:
        from qwythos.models.notes import NoteUpdateForm
...
async def timer(
    ...
    from qwythos.utils.timers import create_timer
...
async def search_knowledge_files(
    ...
    try:
        from qwythos.models.access_grants import AccessGrants
        from qwythos.models.files import Files
        from qwythos.models.knowledge import Knowledges
...
def _grep_file_models(
    ...
    from qwythos.tools.knowledge_fs import build_matcher
...
async def query_chat_files(
    ...
    try:
        from qwythos.retrieval.utils import get_sources_from_items
...
async def query_knowledge_files(
    ...
    try:
        ...
        from qwythos.models.knowledge import Knowledges
        from qwythos.models.notes import Notes
        from qwythos.retrieval.external import retrieve_external_knowledge
        from qwythos.retrieval.utils import query_collection
...
async def query_knowledge_bases(
    ...
    try:
        ...
        from qwythos.models.knowledge import Knowledges
        from qwythos.retrieval.vector.async_client import ASYNC_VECTOR_DB_CLIENT
        from qwythos.routers.knowledge import KNOWLEDGE_BASES_COLLECTION
...
async def view_skill(
    ...
    try:
        from qwythos.models.access_grants import AccessGrants
        from qwythos.models.skills import Skills
...
async def _validate_owned_automation_folder(user_id: str, folder_id: Optional[str]) -> Optional[str]:
    if not folder_id:
        return None
    from qwythos.models.folders import Folders
...
async def create_automation(
    ...
    try:
        from qwythos.models.automations import AutomationData, AutomationForm, Automations
        from qwythos.models.users import Users
        from qwythos.routers.automations import check_automation_limits
        from qwythos.utils.automations import next_n_runs_ns, next_run_ns, validate_rrule
...
async def list_automations(
    ...
    try:
        from qwythos.models.automations import Automations
        from qwythos.models.users import Users
        from qwythos.utils.automations import next_n_runs_ns
...
async def toggle_automation(
    ...
    try:
        from qwythos.models.automations import Automations
        from qwythos.models.users import Users
        from qwythos.utils.automations import next_run_ns
...
async def delete_automation(
    ...
    try:
        from qwythos.models.automations import AutomationRuns, Automations
...
async def search_calendar_events(
    ...
    try:
        from qwythos.models.calendar import CalendarEvents
...
async def create_calendar_event(
    ...
    try:
        from qwythos.models.calendar import CalendarEventForm, CalendarEvents, Calendars
...
async def update_calendar_event(
    ...
    try:
        from qwythos.models.access_grants import AccessGrants
        from qwythos.models.calendar import CalendarEvents, CalendarEventUpdateForm, Calendars
        from qwythos.models.groups import Groups
...
async def delete_calendar_event(
    ...
    try:
        from qwythos.models.access_grants import AccessGrants
        from qwythos.models.calendar import CalendarEvents, Calendars
        from qwythos.models.groups import Groups
