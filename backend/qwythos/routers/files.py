...
from qwythos.config import BYPASS_ADMIN_ACCESS_CONTROL, STORAGE_LOCAL_CACHE, STORAGE_PROVIDER, UPLOAD_DIR
from qwythos.constants import ERROR_MESSAGES
from qwythos.events import EVENTS, publish_event
from qwythos.internal.db import get_async_db_context, get_async_session
...
from qwythos.models.files import (
    FileForm,
    FileListResponse,
    FileModel,
    FileModelResponse,
...
from qwythos.routers.audio import transcribe
from qwythos.routers.retrieval import ProcessFileForm, process_file
...
async def upload_file_handler(
    ...
    try:
        ...
        tags = {
            'Qwythos-User-Email': user.email,
            'Qwythos-User-Id': user.id,
            'Qwythos-User-Name': user.name,
            'Qwythos-File-Id': id,
        }
        try:
