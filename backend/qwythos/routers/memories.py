...
from qwythos.config import RAG_EMBEDDING_CONTENT_PREFIX, RAG_EMBEDDING_QUERY_PREFIX
...
from qwythos.models.memories import Memories, MemoryModel
...
from qwythos.utils.memory import (
...
async def query_memory(
    ...
    if results and relevance_threshold > 0.0 and results.distances and results.distances[0]:
        from qwythos.retrieval.vector.main import SearchResult
