...
from qwythos.env import (
    DEVICE_TYPE,
    RAG_EMBEDDING_TIMEOUT,
)
from qwythos.events import EVENTS, publish_event
from qwythos.internal.db import get_async_db, get_async_session
from qwythos.models.files import FileModel, Files, FileUpdateForm
from qwythos.models.knowledge import Knowledges
from qwythos.models.config import Config

# Document loaders
from qwythos.retrieval.loaders.youtube import YoutubeLoader
from qwythos.retrieval.utils import (
...
from qwythos.retrieval.vector.async_client import ASYNC_VECTOR_DB_CLIENT
from qwythos.retrieval.vector.factory import VECTOR_DB_CLIENT
from qwythos.retrieval.vector.utils import filter_metadata
from qwythos.retrieval.web.azure import search_azure
from qwythos.retrieval.web.bing import search_bing
from qwythos.retrieval.web.bocha import search_bocha
from qwythos.retrieval.web.brave import search_brave
from qwythos.retrieval.web.brave_llm_context import search_brave_llm_context
from qwythos.retrieval.web.duckduckgo import search_duckduckgo
from qwythos.retrieval.web.exa import search_exa
from qwythos.retrieval.web.external import search_external
from qwythos.retrieval.web.firecrawl import search_firecrawl
from qwythos.retrieval.web.google_pse import search_google_pse
from qwythos.retrieval.web.jina_search import search_jina
from qwythos.retrieval.web.kagi import search_kagi

# Web search engines
from qwythos.retrieval.web.main import SearchResult
from qwythos.retrieval.web.microsoft_web_iq import search_microsoft_web_iq
from qwythos.retrieval.web.mojeek import search_mojeek
from qwythos.retrieval.web.ollama import search_ollama_cloud
from qwythos.retrieval.web.perplexity import search_perplexity
from qwythos.retrieval.web.perplexity_search import search_perplexity_search
from qwythos.retrieval.web.searchapi import search_searchapi
from qwythos.retrieval.web.openserp import search_openserp
from qwythos.retrieval.web.searxng import search_searxng
from qwythos.retrieval.web.serpapi import search_serpapi
from qwythos.retrieval.web.serper import search_serper
from qwythos.retrieval.web.serphouse import search_serphouse
from qwythos.retrieval.web.serply import search_serply
from qwythos.retrieval.web.serpstack import search_serpstack
from qwythos.retrieval.web.sougou import search_sougou
from qwythos.retrieval.web.tavily import search_tavily
from qwythos.retrieval.web.utils import get_web_loader
from qwythos.retrieval.web.yacy import search_yacy
from qwythos.retrieval.web.yandex import search_yandex
from qwythos.retrieval.web.ydc import search_youcom
from qwythos.retrieval.web.linkup import search_linkup
from qwythos.storage.provider import Storage
from qwythos.utils.access_control import has_permission
from qwythos.utils.access_control.files import has_access_to_file
...
def get_ef(
    ...
    # Local (in-process) embedding models are not supported in this build -- inference is
    # API-only. Set RAG_EMBEDDING_ENGINE to 'ollama', 'openai', or 'azure_openai' to enable RAG.
    if embedding_model and engine == '':
        log.warning(
            'RAG_EMBEDDING_ENGINE is unset, which normally selects a local embedding model, '
            "but local model execution is disabled in this build. Set RAG_EMBEDDING_ENGINE to "
            "'ollama', 'openai', or 'azure_openai' to enable RAG."
        )
    return None
...
def get_rf(
    ...
    if reranking_model:
        if engine == 'external':
            try:
                from qwythos.retrieval.models.external import ExternalReranker
            ...
            # Local (in-process) reranking models are not supported in this build. Set
            # RAG_RERANKING_ENGINE to 'external' to use a remote reranker endpoint.
            log.warning(
                'RAG_RERANKING_MODEL is set but local reranking is disabled in this build. '
                "Set RAG_RERANKING_ENGINE to 'external' to use a remote reranker."
            )
...
def get_transformers_tokenizer(request: Request, config: RetrievalConfig):
    # Local HuggingFace tokenizers are not supported in this build -- inference is API-only.
