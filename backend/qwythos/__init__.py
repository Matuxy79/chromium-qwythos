...
def version_callback(value: bool) -> None:
    if value:
        from qwythos.env import VERSION

        typer.echo(f'Qwythos version: {VERSION}')
        raise typer.Exit()
...
def serve(
    ...
    import qwythos.main  # noqa: F401
    from qwythos.env import UVICORN_WORKERS  # Import the workers setting
