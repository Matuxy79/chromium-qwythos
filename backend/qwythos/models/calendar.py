...
from qwythos.internal.db import Base, get_async_db_context
from qwythos.models.access_grants import AccessGrantModel, AccessGrants
from qwythos.models.groups import Groups
from qwythos.models.users import User, UserModel, UserResponse
...
class CalendarEventTable:
    ...
    async def get_upcoming_events(
        ...
        *grace_ns* widens the SQL lower bound so that events whose start_at
        ...
        time.
        """
        from qwythos.models.users import User as UserRow
