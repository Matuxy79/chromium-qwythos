...
# local imports
from qwythos.internal.db import Base, JSONField, get_async_db_context
from qwythos.models.automations import AutomationRun
from qwythos.models.chat_messages import ChatMessage, ChatMessages
from qwythos.models.folders import Folders
from qwythos.models.tags import Tag, TagModel, Tags
from qwythos.utils.misc import get_output_text, sanitize_data_for_db, sanitize_text_for_db
...
class ChatTable:
    ...
    async def insert_shared_chat_by_chat_id(self, chat_id: str, db: AsyncSession | None = None) -> ChatModel | None:
        ...
        from qwythos.models.shared_chats import SharedChats
    ...
    async def get_chats_by_model_id(
        ...
        from qwythos.models.users import User
    ...
    async def delete_shared_chats_by_user_id(self, user_id: str, db: AsyncSession | None = None) -> bool:
        ...
        from qwythos.models.shared_chats import SharedChat as SharedChatTable
        from qwythos.models.shared_chats import SharedChats
