...
from qwythos.env import DATABASE_USER_ACTIVE_STATUS_UPDATE_INTERVAL
from qwythos.internal.db import Base, JSONField, get_async_db_context
from qwythos.utils.misc import throttle
...
class UsersTable:
    ...
    async def get_users(
        ...
        async with get_async_db_context(db) as session:
            ...
            from qwythos.models.channels import ChannelMember
            from qwythos.models.groups import GroupMember
