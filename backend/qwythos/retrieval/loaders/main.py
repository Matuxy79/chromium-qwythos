...
from qwythos.retrieval.loaders.datalab_marker import DatalabMarkerLoader
from qwythos.retrieval.loaders.external_document import ExternalDocumentLoader
from qwythos.retrieval.loaders.mineru import MinerULoader
from qwythos.retrieval.loaders.mistral import MistralLoader
from qwythos.retrieval.loaders.paddleocr_vl import PADDLEOCR_VL_SUPPORTED_EXTENSIONS, PaddleOCRVLLoader
from qwythos.utils.headers import get_user_groups_for_custom_headers
        ...
        with open(self.file_path, 'rb') as f:
            ...
            r = requests.post(
                ...
                data={
                    ...
                    # values here would make Qwythos responsible for Docling's API
    ...
    def _get_loader(self, filename: str, file_content_type: str, file_path: str):
        ...
        if (
            ...
            if not api_base_url or api_base_url.strip() == '':
                api_base_url = 'https://www.datalab.to/api/v1/marker'  # https://github.com/qwythos/qwythos/pull/16867#issuecomment-3218424349
