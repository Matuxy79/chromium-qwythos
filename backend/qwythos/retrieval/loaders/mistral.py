...
from qwythos.env import AIOHTTP_CLIENT_SESSION_SSL, ENABLE_FORWARD_USER_INFO_HEADERS, GLOBAL_LOG_LEVEL
...
class MistralLoader:
    ...
    def __init__(
        ...
        self.headers = {
            ...
            'User-Agent': 'Qwythos-MistralLoader/2.0',  # Helps API provider track usage
        }
    ...
    async def _get_session(self):
        ...
        async with aiohttp.ClientSession(
            connector=connector,
            timeout=timeout,
            headers={'User-Agent': 'Qwythos-MistralLoader/2.0'},
