...
from qwythos.env import AIOHTTP_CLIENT_SESSION_SSL, SEARXNG_CLIENT_CERT_FILE, SEARXNG_CLIENT_KEY_FILE
from qwythos.retrieval.web.main import SearchResult, get_filtered_results
...
_SEARXNG_HEADERS = {
    'User-Agent': 'Qwythos (https://github.com/qwythos/qwythos) RAG Bot',
    'Accept': 'text/html',
