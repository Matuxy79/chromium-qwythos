...
# can't be a legitimate Qwythos collection name.
...
class MilvusClient(VectorDBBase):
    ...
    def _get_collection_and_resource_id(self, collection_name: str) -> Tuple[str, str]:
        ...
        WARNING: This mapping relies on current Qwythos naming conventions for
        collection names. If Qwythos changes how it generates collection names
