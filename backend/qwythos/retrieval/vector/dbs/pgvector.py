...
from qwythos.retrieval.vector.utils import merge_hybrid_search_results, process_metadata
from qwythos.utils.misc import sanitize_text_for_db
    ...
    def _ensure_vector_index(self, index_method: str, index_options: str) -> None:
        ...
        if existing_method and existing_method != index_method:
            raise RuntimeError(
                ...
                'and recreate it with the new method before restarting Qwythos.'
            )
