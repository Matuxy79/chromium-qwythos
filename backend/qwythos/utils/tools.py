...
from qwythos.tools.builtin import (
    add_memory,
    calculate_timestamp,
    create_automation,
...
from qwythos.utils.access_control import has_access, has_connection_access, has_permission
from qwythos.utils.headers import get_custom_headers, include_user_info_headers
from qwythos.utils.misc import is_string_allowed
from qwythos.utils.plugin import get_tool_contents_cache, get_tools_cache, load_tool_module_by_id
...
async def get_builtin_tools(
    ...
    if is_builtin_tool_enabled('knowledge'):
        from qwythos.env import ENABLE_KB_EXEC
    ...
    if getattr(request.state, 'internal', False) is True:
        from qwythos.utils.subagents import MUTATING_MEMORY_TOOLS
