...
from qwythos.constants import TASKS
...
from qwythos.models.oauth_sessions import OAuthSessions
from qwythos.models.users import UserModel, Users
...
from qwythos.routers.pipelines import (
    get_sorted_filters,
...
from qwythos.routers.tasks import (
    generate_chat_tags,
    generate_follow_ups,
...
from qwythos.utils.access_control import has_connection_access, has_permission
from qwythos.models.access_grants import AccessGrants
from qwythos.utils.access_control.files import get_owner_accessible_folder_files
...
from qwythos.utils.context_compaction import compact_messages_for_request
from qwythos.utils.files import (
    convert_markdown_base64_images,
    get_file_url_from_base64,
    get_image_base64_from_url,
    get_image_url_from_base64,
)
from qwythos.utils.filter import (
    FilterContext,
    get_filter_functions,
    process_filter_functions,
)

from qwythos.utils.json_codec import JSONCodec
from qwythos.utils.mcp.client import MCPClient
from qwythos.utils.memory import add_memory_context, review_memory_after_turn
...
from qwythos.utils.payload import apply_system_prompt_to_body, resolve_system_prompt
from qwythos.utils.plugin import load_function_module_by_id
...
from qwythos.utils.tools import (
...
async def process_chat_payload(request, form_data, user, metadata, model):
    ...
    if skill_ids:
        from qwythos.models.skills import Skills as SkillsModel
        ...
        async def response_handler(response, events):
            ...
            def tag_output_handler(content_type, tags, output):
                ...
                output_type_map = {
                    ...
                    'code_interpreter': 'qwythos:code_interpreter',
                }
                ...
                if last_type == 'message':
                    ...
                    for start_tag, end_tag in tags:
                        ...
                        if match:
                            ...
                            elif output_item_type == 'qwythos:code_interpreter':
                                output.append(
                                    {
                                        'type': 'qwythos:code_interpreter',
                                        'id': output_id('ci'),
                                        'status': 'in_progress',
                                        'start_tag': start_tag,
                                        'end_tag': end_tag,
                    ...
                    or (last_type == 'qwythos:code_interpreter' and content_type == 'code_interpreter')
                    ...
                    elif last_type == 'qwythos:code_interpreter':
            ...
            try:
                                    ...
                                    if value:
                                        ...
                                        inside_tag_block = (
                                            ...
                                            and (
                                                ...
                                                or last_item_type == 'qwythos:code_interpreter'
                                                or (
                                        ...
                                        if inside_tag_block:
                                            ...
                                            if last_item_type == 'qwythos:code_interpreter':
                ...
                if DETECT_CODE_INTERPRETER:
                    ...
                    while output and output[-1].get('type') == 'qwythos:code_interpreter' and retries < MAX_RETRIES:
                        await event_emitter(
                            {
                                'type': 'chat:completion',
                                'data': {
