...
from qwythos.models.groups import GroupForm, GroupModel, Groups, GroupUpdateForm
from qwythos.models.oauth_sessions import OAuthSessions
from qwythos.models.users import Users
from qwythos.retrieval.web.utils import get_ssrf_safe_session, validate_url
from qwythos.utils.auth import create_token, get_password_hash
from qwythos.utils.groups import apply_default_group_assignment
from qwythos.utils.misc import parse_duration
from qwythos.utils.validate import validate_profile_image_url
...
from qwythos.env import GLOBAL_LOG_LEVEL
    ...
    try:
        ...
        if oauth_server_metadata is None or not oauth_server_metadata.authorization_endpoint:
            ...
            raise Exception(
                ...
                'expose RFC 8414 / RFC 9728 discovery documents so Qwythos can '
...
class OAuthManager:
    ...
    async def update_user_groups(self, user, user_data, default_permissions, db=None):
        ...
        log.debug(f'All groups available in Qwythos: {[g.name for g in all_available_groups]}')
