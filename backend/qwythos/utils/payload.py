...
from qwythos.utils.chat_variables import render_chat_variables, render_user_variables
from qwythos.utils.task import prompt_template, prompt_variables_template
...
def remove_qwythos_params(params: dict) -> dict:
    """
    Removes Qwythos specific parameters from the provided dictionary.

    Args:
        params (dict): The dictionary containing parameters.

    Returns:
        dict: The modified dictionary with Qwythos parameters removed.
    """
    qwythos_params = {
...
def apply_model_params_to_body_openai(params: dict, form_data: dict) -> dict:
    params = remove_qwythos_params(params)
