...
from qwythos.models.functions import FunctionModel, Functions
...
def replace_imports(content):
    ...
    """
    replacements = {
        'from utils': 'from qwythos.utils',
        'from apps': 'from qwythos.apps',
        'from main': 'from qwythos.main',
        'from config': 'from qwythos.config',
    }
